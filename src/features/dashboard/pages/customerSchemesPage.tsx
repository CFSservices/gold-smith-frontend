...
export function CustomerSchemesPage() {
  ...
  return (
    <div className="body dark:body">
      {/* Header */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 m-0 px-4 py-2 flex-shrink-0">
        <div>
          <h1 className="text-3xl sm:text-2xl font-bold text-secondary-900 dark:text-white m-0">
            Schemes
          </h1>
          <p className="text-sm sm:text-base text-secondary-500 dark:text-secondary-400 m-0">
            Schemes
          </p>
        </div>
        <Button
...
export default CustomerSchemesPage;
